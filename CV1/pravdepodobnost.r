...
uplna_pravdepodobnost <- function(P_B, P_AB) { # uvažujeme P_B jako vektor hodnot P(B_i) a P_BA jako vektor hodnot P(A|B_i)
    P_A <- 0
...
bayes <- function(P_B, P_AB, k) { # uvažujeme P_B jako vektor hodnot P(B_i), P_BA jako vektor hodnot P(A|B_i)
